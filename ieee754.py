...
class IEEE754:
    ...
    def __init__(self, x: float = 13.375, precision: int = 2):
        ...
        self.m = np.append(self.i[1::], self.d)  # Integer part + decimal part
        self.h = ""  # Hex repr
    ...
    def __str__(self):
        ...
        r[(self.exponent + 1):((self.exponent + 1) + i_d.size)] = i_d[0:self.mantissa]
